      ...
      <Grid>
        <Paper elevation={20} style={paperStyle}>
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <TextField fullWidth label="Email" name="email" type="email" placeholder="Enter your email"
              onChange={this.handleChange} required />
            ...
            <FormControl style={{ margin: '3px', minWidth: '120px' }}>
              ...
              <Select defaultValue="" id="grouped-select"
                onChange={this.handleChange} required name="branch">
            ...
            <FormControl style={{ margin: '3px', minWidth: '150px' }}>
              ...
              <Select defaultValue="" id="grouped-select"
                onChange={this.handleChange} required name="year">
